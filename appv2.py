...
<style>
    ...
    .sub-header, .stCaption, [data-testid="stCaptionContainer"] {
    ...
    if len(results) == 1:
        ...
        with c1:
            ...
            if lengths:
                ...
                ax.hist(lengths, bins=50, color="#8fbcbb", edgecolor='#20262d', alpha=0.9)
        ...
        if vals:
            st.area_chart(pd.DataFrame({'GC%': vals}, index=pos), color="#8fbcbb")
        ...
        if c_data.get('aa_dist'):
            ...
            fig_aa = px.bar(
                ...
                template='plotly_dark', color_continuous_scale="Greys",
...
# ============================================
        ...
        fig_scatter = px.scatter(
            ...
            hover_name="ชื่อสายพันธุ์ (Organism)", color_continuous_scale="Greys", template="plotly_dark",
        ...
        with c1:
            ...
            ax_bar.barh(df_sorted["ชื่อสายพันธุ์ (Organism)"], df_sorted["สัดส่วน Non-coding (%)"], color="#87909a")
        ...
        with c2:
            ...
            ax_bar2.barh(df_sorted_len["ชื่อสายพันธุ์ (Organism)"], df_sorted_len["ขนาดจีโนม (bp)"], color="#a4adb7") 
